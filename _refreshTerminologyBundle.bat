...
COPY input\vocabulary\codesystem\codesystem-medication-request-category.json bundlegen\sourcefiles\codesystem-medicationrequest-category.json
COPY input\vocabulary\codesystem\codesystem-medication-request-status.json bundlegen\sourcefiles\codesystem-medicationrequest-status.json
