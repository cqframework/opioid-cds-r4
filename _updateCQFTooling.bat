...
SET "dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=org.opencds.cqf&a=tooling-cli&v=2.4.0-SNAPSHOT"
SET tooling_jar=tooling-2.4.0-SNAPSHOT.jar
